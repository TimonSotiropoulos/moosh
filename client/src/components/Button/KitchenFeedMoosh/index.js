...
class ToKitchen extends Component {
    ...
    _renderArrow = () => {
        return (
            <svg x={400} y={5} width={110} height={110} viewBox="0 0 80.84 97.35" style={{transform: ''}}>
    ...
    render() {
        ...
        const x = (2048/2 - 250);
        return (
            <svg x={1508} y={1380} width={540} height={80} viewBox='0 0 350 120'>
              <g className={Components.button} onClick={onClick}>
                <rect  rx="60" x="20" y="0" width="500" height="120" />
                <text className={[Text.buttonToKitchen].join(" ")} x={75} y={78}>Feed Moosh</text>
                {this._renderArrow()}
              </g>
            </svg>
        )
