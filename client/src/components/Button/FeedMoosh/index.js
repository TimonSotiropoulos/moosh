...
class FeedMoosh extends Component {

    _renderArrow = () => {
        return (
            <svg x={450} y={5} width={110} height={110} viewBox="0 0 80.84 97.35">
    ...
    render() {
        ...
        const x = (2048/2 - 250);
        return (
            <svg x={1385} y={1270} width={600} height={120} viewBox='0 0 700 120'>
              <g className={Components.button} onClick={onClick}>
                <rect  rx="60" x="20" y="0" width="550" height="120" />
                <text className={[Text.button].join(" ")} x={60} y={78}>Feed Moosh!</text>
                {this._renderArrow()}
              </g>
            </svg>
        )
