...
class Title extends Component {
    ...
    render() {
        ...
        return (
            <svg xmlns="http://www.w3.org/2000/svg" width={863} height={81} x={600} y={80} viewBox="0 0 863.33 81.38">
            <defs>
                <style>
                    {`.title-text-cls-1{fill:#fff}.title-text-cls-2{fill:#cdc5d5}`}
                </style>
            </defs>
            <title>
                Heading
